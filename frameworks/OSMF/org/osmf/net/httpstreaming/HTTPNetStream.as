...
package org.osmf.net.httpstreaming
{
	...
	public class HTTPNetStream extends NetStream
	{
		...
		override public function set bufferTime(value:Number):void
		{
			...
			//for vods set max buffer time to higher value
			if(NetStreamUtils.getStreamType(_resource) != StreamType.LIVE){
				_desiredBufferTime_Max = _desiredBufferTime_Min + OSMFSettings.hdsAdditionBufferTimeForVOD;
			}else{
...
//		}
		...
		protected var _desiredBufferTime_Min:Number = 0;
		protected var _desiredBufferTime_Max:Number = 0;
