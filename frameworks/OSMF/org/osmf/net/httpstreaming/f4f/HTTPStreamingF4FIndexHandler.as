...
package org.osmf.net.httpstreaming.f4f
{
	...
	public class HTTPStreamingF4FIndexHandler extends HTTPStreamingIndexHandlerBase
	{
		...
		{
			return uint(int(time / _f4fIndexInfo.bestEffortFetchInfo.fragmentDuration)) + 1;
		}
		...
		private function initiateBestEffortRequest(nextFragmentId:uint, quality:int):HTTPStreamRequest
		{
			...
			var denominator:Number = _f4fIndexInfo.bestEffortFetchInfo.segmentDuration/_f4fIndexInfo.bestEffortFetchInfo.fragmentDuration;
			var guessSegmentNumber:uint = uint((Number(nextFragmentId) /denominator) + 0.5);
