...
package org.osmf.net
{
	...
	public class NetStreamPlayTrait extends PlayTrait
	{
		...
		private function registerStreams():void{
			if(urlResource is DynamicStreamingResource){
				for each(var stream:DynamicStreamingItem in (urlResource as DynamicStreamingResource).streamItems){
					netConnection.call("FCSubscribe",null,stream.streamName);
				}
			}
		}
